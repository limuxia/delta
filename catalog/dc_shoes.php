...
$req = mysql_query('SELECT id,name,size,norm,description,photo FROM shoes ORDER BY sequence LIMIT ' . $firstmessage . ', ' . $nbprodbypage); 
...
for ($i = 1 ; $i < $num ; $i++) { 
echo '<a href="index.php?dir=catalog&page=shoes&num=' . $i . '">'. $i .'</a> &nbsp;|&nbsp; '; 
} 
echo '<a href="index.php?dir=catalog&page=shoes&num=' . $num . '"><b><font size="+1">'. $num .'</font></b></a> &nbsp;|&nbsp; ';
