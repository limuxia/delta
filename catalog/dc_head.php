...
$req = mysql_query('SELECT id,name,norm,description,photo FROM head ORDER BY sequence LIMIT ' . $firstmessage . ', ' . $nbprodbypage); 
...
echo '<a href="index.php?dir=catalog&page=head&num=' . $num . '"><b><font size="+1">'. $num .'</font></b></a> &nbsp;|&nbsp; ';
