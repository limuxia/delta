...
$req = mysql_query('SELECT id,name,norm,description,photo FROM fall_arrest ORDER BY sequence LIMIT ' . $firstmessage . ', ' . $nbprodbypage); 
...
for ($i = 1 ; $i < $num ; $i++) { 
echo '<a href="index.php?dir=catalog&page=fall_arrest&num=' . $i . '">'. $i .'</a> &nbsp;|&nbsp; '; 
} 
echo '<a href="index.php?dir=catalog&page=fall_arrest&num=' . $num . '"><b><font size="+1">'. $num .'</font></b></a> &nbsp;|&nbsp; ';
