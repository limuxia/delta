/*rule  验证规则(部分用正则表达式)：
        ...
        number                  x位数字            ^[0-9]{x}$
        notNegativeInteger      非负整数            ^[0-9]{1,}$
        notNegativeDecimal      非负小数            ^[0-9]{1,}[.]{1}[0-9]{1,}$
        notNagetive             非负整数或小数     (^[0-9]{1,}$)|(^[0-9]{1,}[.]{1}[0-9]{1,}$)
            ...
            else
            {
                switch (rule) {
                    case 'choiceCheck':
                        ...
                        if(j==l)    //没有一个被选中
                        {
                            alert(prompt+": Choose at least one!");
                            element.focus();
                            return false;
                        }
                        break;
                    case 'fileCheck':
                        ...
                        if(maxCount==0 || files1.length<=maxCount)
                        {
                            ...
                            for (var i in files1)
                            {
                                ...
                                {
                                    alert(prompt + ": The size of each file uploaded cannot exceed: " + maxSize + "M");
                                    element.focus();
                                    return false;
                                }
                            }
                        ...
                        {
                            alert(prompt+": Only upload 1-"+maxCount+" photos!");
                            element.focus();
                            return false;
                        }
                        break;
                    case 'length':
                        ...
                        if (element.value.length != length) {
                            alert(prompt + ": Length must be " + length);
                            element.focus();
                            return false;
                        }
                        break;
                    case 'minLength':
                        var length = inputArray[i][3];
                        if (element.value.length < length) {
                            alert(prompt + ": At least " + length + " in length");
                            element.focus();
                            return false;
                        }
                        break;
                    case 'email':
                        ...
                        if (!regExpValidate.test(element.value)) {
                            alert(prompt + ": Not a correct email address!");
                            element.focus();
                            return false;
                        }
                        break;
                    case 'date':
                        ...
                        if (!regExpValidate.test(element.value)) {
                            alert(prompt + ": Date format is incorrect: yyyy/mm/dd or yyyy-mm-dd");
                            element.focus();
                            return false;
                        }
                        break;
                    case 'number':
                        ...
                        if (!regExpValidate.test(element.value)) {
                            alert(prompt + ": Must be " + length + " numbers!");
                            element.focus();
                            return false;
                        }
                        break;
                    case 'notNegativeInteger':
                        ...
                        if (!regExpValidate.test(element.value)) {
                            alert(prompt + ": Must be a non-negative integer!");
                            element.focus();
                            return false;
                        }
                        break;
                    case 'notNagetiveDecimal':
                        ...
                        if (!regExpValidate.test(element.value)) {
                            alert(prompt + ": Must be non-negative decimal!");
                            element.focus();
                            return false;
                        }
                        break;
                    case 'notNagetive':
                        ...
                        if (!regExpValidate.test(element.value)) {
                            alert(prompt + ": Must be a non-negative integer or decimal");
                            element.focus();
                            return false;
                        }
                        break;
