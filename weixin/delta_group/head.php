...
while ($data = mysql_fetch_array($req)){ 
 echo '<td><table style="width:396px" cellspacing="10"><tr><td width="150px" rowspan="4" align="center"><img src="../';
 ...
 if($data['norm']=='pictures/norm/head/')
 {
 	echo '<img src="';
...
for ($i = 1 ; $i < $num ; $i++) { 
echo '<a href="content2.php?content=head&num=' . $i . '">'. $i .'</a> &nbsp;|&nbsp; '; 
} 
echo '<a href="content2.php?content=head&num=' . $num . '"><b><font size="+1">'. $num .'</font></b></a> &nbsp;|&nbsp; ';
